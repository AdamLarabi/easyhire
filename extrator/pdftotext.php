...
<body>
    <header class="header">
        <nav class="nav">
            <a href="#" class="nav_logo">easy.he</a>
            <ul class="nav_items">
                <li class="nav_item">
        ...
        <form method="post" class="content" action="pdftotext.php">
            <div class="upl">
                <div class="cl1">
                    ...
                    <textarea cols="30" rows="5" class="form-control" type="textarea"
                        name="competances"><?php echo $copm; ?></textarea>
                </div>
                <br><br>
                <div class="cl2">
                ...
                <div class="cl3">
                    ...
                    <textarea cols="30" rows="5" class="form-control" type="textarea"
                        name="certificat"><?php echo $certif; ?></textarea>
                </div>
                <br><br>
                <div class="cl4">
